...
def check_collision(pipes, lives):
    for pipe in pipes:
...
def lives_display(lives):
    lives_surface = game_font.render("Lives: " + str(lives), True, (255,255,255))
    lives_rect = lives_surface.get_rect(center=(500,50))
...
while True:
    ...
    if game_active:
        ...
        game_active, lives = check_collision(pipe_list, lives)
        #lives = check_collision(pipe_list, lives)
        #if lives <= 0:
        #    gave_active = False
        #    #lives = 5
        #else:
